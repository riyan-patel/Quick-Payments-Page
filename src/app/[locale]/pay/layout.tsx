    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 -z-10" aria-hidden>
        ...
        <div
          ...
          style={{
            background: `
              linear-gradient(168deg, oklch(0.15 0.02 85) 0%, oklch(0.13 0.02 90) 45%, oklch(0.12 0.025 95) 100%)
            `,
          }}
        />
        <div
        ...
        <div
          ...
          style={{
            ...
            backgroundSize: "48px 48px",
            maskImage:
              "radial-gradient(ellipse 90% 70% at 50% 0%, white 20%, transparent 70%)",
          }}
        />
        <div
        ...
        />
        <div
          className="absolute inset-0 opacity-[0.35] mix-blend-overlay dark:opacity-20"
          style={{
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-oklch(0.96 0.02 85 / 0.5) dark:to-background/50"
          aria-hidden
        />
      </div>
      <a
